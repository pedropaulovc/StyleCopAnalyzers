...
namespace StyleCop.Analyzers.Test.LayoutRules
{
    ...
    using TestHelper;
    using Xunit;
    using static StyleCop.Analyzers.Test.Verifiers.CustomDiagnosticVerifier<StyleCop.Analyzers.LayoutRules.SA1521UseLineEndingingsConsistently>;

    /// <summary>
    /// Unit tests for <see cref="SA1521UseLineEndingingsConsistently"/>.
    /// </summary>
    public class SA1521UnitTests
    {
...
public class Foo
{
    public void Bar(int i)
    {
        ...
        {
            var test = new StyleCopCodeFixVerifier<SA1521UseLineEndingingsConsistently, SA1521CodeFixProvider>.CSharpTest
            {
                TestCode = source,
            };
      ...
      ""newlineAtEndOfFile"": ""{newlineAtEndOfFile.ToString().ToLowerInvariant()}""
        ...
        private DiagnosticDescriptor GetDescriptor(OptionSetting? endOfFileHandling)
        {
            ...
            case OptionSetting.Require:
                return SA1521UseLineEndingingsConsistently.Descriptor;

            case OptionSetting.Omit:
                return SA1521UseLineEndingingsConsistently.DescriptorOmit;

            case OptionSetting.Allow:
            case null:
            default:
                return SA1521UseLineEndingingsConsistently.DescriptorAllow;
            }
        }
    }
}
